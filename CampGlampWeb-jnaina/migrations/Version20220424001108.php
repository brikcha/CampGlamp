 ...
 */
final class Version20220424001108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calender (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, description LONGTEXT NOT NULL, all_day TINYINT(1) NOT NULL, background_color VARCHAR(7) NOT NULL, text_color VARCHAR(7) NOT NULL, bordr_color VARCHAR(7) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('DROP TABLE blog');
        $this->addSql('ALTER TABLE activite DROP nombre de participants, CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE eventperso DROP iduser, CHANGE idep idep INT AUTO_INCREMENT NOT NULL, CHANGE lieu location VARCHAR(255) NOT NULL, ADD PRIMARY KEY (idep)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog (id INT AUTO_INCREMENT NOT NULL, nomBlog VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, descriptionBlog VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, imgBlog VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, idUser INT NOT NULL, INDEX idUser (idUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE activite ADD nombre de participants INT DEFAULT NULL, CHANGE id id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE eventperso ADD iduser INT NOT NULL, CHANGE idep idep INT NOT NULL, CHANGE location lieu VARCHAR(255) NOT NULL');
